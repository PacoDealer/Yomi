...
| 35 | 2026-04-15 | Deep research session. No code shipped. RESEARCH.md created as permanent master research doc (replaces RESEARCH_S35.md). Research: Mihon iOS impossible (APK/Dalvik), Aidoku WASM=Rust SDK (S40+), Paperback TS ecosystem unlock (S37), iOS 26 Liquid Glass 3-layer icon system + Icon Composer, JSContext 12-15x slower than WKWebView but correct for Yomi (sync bridge + background execution), Apple xcrun mcpbridge available in Xcode 26.3. Session plans written for S36-S38. |
