...
## Current state (post S120 — 2026-08-27 · Suwayomi detail/reader fixed end-to-end + OAuth login-CSRF closed on all 4 trackers)
...
**Next session**: ~33 substantive findings left (rows 108-110/112-122, 125/129/132-134/136-137,
139-144/146/150-156) + 6 doc-only (157-162). Suggested next: **#108** (unused refresh token silently
kills tracker sync forever) and **#114** (partially-read titles never appear in History) — both real
user-facing correctness gaps, plus the #132-137 dead-code batch is quick.
