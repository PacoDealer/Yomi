...
**Next session**: ~24 substantive findings left (rows 109-110/112-113/115-122, 129,
139-144/146/151-156) + 6 doc-only (157-162). Suggested next: **#129** (the widget's "last chapter"
is a hardcoded literal), **#146** (Suwayomi/OPDS load failures look like "nothing configured"), and
the #139-144 performance batch.
